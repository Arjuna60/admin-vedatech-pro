...
@Component({
  selector: 'app-suppliers-all-invoices',
  templateUrl: './suppliers-all-invoices.component.html',
  styleUrls: ['./suppliers-all-invoices.component.css']
})
export class SuppliersAllInvoicesComponent implements OnInit {
